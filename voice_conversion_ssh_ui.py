...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pb_upload.setGeometry(QtCore.QRect(120, 390, 131, 41))
        font = QtGui.QFont()
        ...
        self.pb_convert.setGeometry(QtCore.QRect(310, 390, 131, 41))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.pb_download.setGeometry(QtCore.QRect(490, 390, 131, 41))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.label.setGeometry(QtCore.QRect(270, 400, 31, 21))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        ...
        self.label_2.setGeometry(QtCore.QRect(450, 400, 41, 21))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label_6.setGeometry(QtCore.QRect(130, 140, 141, 21))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.listWidget.setGeometry(QtCore.QRect(190, 190, 351, 181))
        font = QtGui.QFont()
        ...
        self.pb_show_model.setGeometry(QtCore.QRect(280, 130, 181, 41))
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        font.setPointSize(14)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "請先點選model:"))
